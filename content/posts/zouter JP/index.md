---
title: Zouter JP BGP Global - Standard 测评
...
`活动日期：2026年6月18日~2026年7月1日`
   ...
   > {{< collapse summary="**💻基本信息**" >}}

![基本配置](基本信息.webp)

   {{</ collapse >}}

   > {{< collapse summary="**🎬IP质量**" >}}

![基本配置](IP质量.webp)

   {{</ collapse >}}

   > {{< collapse summary="**🌐网络质量**" >}}

![基本配置](网络质量.webp)

   {{</ collapse >}}

   > {{< collapse summary="**📍回程路由**" >}}
...
这款JP只能说中规中矩，定位代理机，`skyline下游` 电信IIJ和softbank，联通NTT+softbank（第一次测试都是软银）移动lumen，这个机器很难评，机器说是不承诺大陆连接，但也算个小优化机器吧，整体来看延迟会比绿云JP2222低一点，但是随着开售之后邻居多了，IP也变差了，后面只能靠DNS来解锁，一开始是原生全绿的，10天后看在探针上体现丢包比绿云还严重，不知道是人多的原因还是网络问题，在我本地移动的体感中和绿云JP2222相差不大
